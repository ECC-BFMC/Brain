...
autodoc_mock_imports = ["multiprocessing","cv2","serial","django","pynput","numpy","server_data","server_listener","server_subscriber","position_listener","utils","complexdecoder"]
