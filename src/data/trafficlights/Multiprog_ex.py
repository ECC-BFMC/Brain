#
#  ******************************************************************************
#  * @file     Example_multiprogramming.py
#  * @author   RBRO/PJ-IU
#  * @version  V0.0.1
#  * @date     17-01-2020 GMOIS
...
import Listener
# Module required for multiprocessing example
from multiprocessing import Process
import os

## Method for running the listener example.
#  @param nem The name of the process.
def runListener():
...
if __name__ == "__main__":
    p = Process(target=runListener, args=())
    p.start()
    p.join()
